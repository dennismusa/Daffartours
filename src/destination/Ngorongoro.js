  ...
  const highlights = [
    {
      ...
      text: "Descend into the world's largest intact volcanic caldera and discover an extraordinary concentration of wildlife.",
    },
    {
      number: "02",
      title: "Big Five",
      text: "Look for lions, elephants, buffalo, leopards and rhinos across the crater's remarkable landscapes.",
    },
    {
      number: "03",
      title: "Unique Landscapes",
      text: "Experience dramatic crater walls, open grasslands, forests, lakes and spectacular highland scenery.",
    },
    {
      number: "04",
      title: "Maasai Culture",
      text: "Discover the traditions and way of life of Maasai communities living around the Ngorongoro Conservation Area.",
    },
  ];
      ...
      <section className="relative min-h-[70vh] max-h-[800px] overflow-hidden">
        ...
        <div className="absolute bottom-10 left-6 md:left-16 max-w-3xl text-white">
          ...
          <p className="mt-4 text-white/80 text-lg md:text-xl max-w-2xl leading-relaxed">
            A spectacular volcanic crater, incredible wildlife,
            dramatic landscapes and unforgettable African safari experiences.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative group">
              ...
              <img
                src={ngorongoro2}
                alt="Ngorongoro wildlife experience"
              ...
              <div className="absolute bottom-5 left-5 bg-[#0D4825]/95 backdrop-blur-md text-white px-6 py-4 rounded-2xl shadow-xl">
                ...
                <p className="text-white/70 text-xs mt-1">
                  Tanzania's legendary crater destination
                </p>
            ...
            <div>
              ...
              <p className="mt-6 text-gray-600 leading-relaxed">
                The Ngorongoro Conservation Area is one of Tanzania's
                most remarkable safari destinations. At its heart lies
                the spectacular Ngorongoro Crater, a vast natural enclosure
                filled with wildlife.
              </p>

              <p className="mt-4 text-gray-600 leading-relaxed">
                From dramatic crater landscapes to extraordinary wildlife
                encounters and authentic cultural experiences, Ngorongoro
                offers an unforgettable journey through one of Africa's
                most fascinating environments.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-4 mt-8">
                ...
                <div className="group p-5 rounded-2xl bg-[#F7F4EA] border border-[#0D4825]/5 hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    One of Africa's great landscapes
                  </p>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="mt-5 text-gray-600 leading-relaxed">
              Descend into the crater and explore a remarkable landscape
              where wildlife, forests, grasslands and lakes exist together.
            </p>
          ...
          <div className="grid lg:grid-cols-[1.15fr_.85fr] gap-6">
            ...
            <div className="flex flex-col justify-center bg-[#0D4825] rounded-[2rem] p-8 sm:p-10 lg:p-12">
              ...
              <p className="mt-6 text-white/65 leading-relaxed">
                A Ngorongoro safari takes you into a remarkable natural
                world. Follow wildlife across the crater floor, admire
                the surrounding highlands and experience the changing
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            <div>
              ...
              <p className="mt-6 text-white/65 leading-relaxed max-w-xl">
                Ngorongoro combines incredible wildlife, dramatic
                volcanic scenery and cultural experiences into one
                of Tanzania's most memorable safari destinations.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              <p className="mt-6 text-gray-600 leading-relaxed">
                Ngorongoro provides exceptional opportunities to see
                a wide variety of wildlife within a spectacular natural
                setting.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              <p className="mt-6 text-gray-600 leading-relaxed">
                Whether you are planning a short northern Tanzania safari
                or a longer East African adventure, we can help create an
                itinerary around your interests, travel style and schedule.
              </p>
            ...
            <div className="relative group">
              ...
              <img
                src={ngorongoro1}
                alt="Ngorongoro safari landscape"
                className="w-full h-[400px] sm:h-[520px] object-cover rounded-[2rem] shadow-2xl transition-transform duration-700 group-hover:scale-[1.03]"
              />
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <div className="text-center mb-10">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-gray-600 leading-relaxed">
              A glimpse of the crater, wildlife, landscapes and unforgettable
              moments waiting for you in Ngorongoro.
            </p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-10">
            ...
            <div className="p-6 rounded-2xl bg-white/[0.05] border border-white/10 hover:border-[#F39A08]/40 transition-all duration-300">
              ...
              <p className="mt-2 text-white/55 text-sm leading-relaxed">
                Early game drives can offer beautiful light and excellent
            ...
            <div className="p-6 rounded-2xl bg-white/[0.05] border border-white/10 hover:border-[#F39A08]/40 transition-all duration-300">
              ...
              <p className="mt-2 text-white/55 text-sm leading-relaxed">
                Keep your camera ready for wildlife, crater landscapes
            ...
            <div className="p-6 rounded-2xl bg-white/[0.05] border border-white/10 hover:border-[#F39A08]/40 transition-all duration-300">
              ...
              <p className="mt-2 text-white/55 text-sm leading-relaxed">
                Comfortable layers and suitable footwear are useful when
                exploring Tanzania's highland environments.
              </p>
      ...
      <section className="relative bg-[#0D4825] overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-5 sm:px-8 py-16 sm:py-20 lg:py-28 text-center">
          ...
          <p className="mt-5 max-w-2xl mx-auto text-white/65 leading-relaxed">
            Let Daffar Tours & Travel help you turn your Ngorongoro
