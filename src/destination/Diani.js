        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative group">
              ...
              <img
                src={diani2}
                alt="Diani Beach coastal experience"
              ...
              <div className="absolute bottom-5 left-5 bg-[#0D4825]/95 backdrop-blur-md text-white px-6 py-4 rounded-2xl shadow-xl">
                ...
                <p className="text-white/70 text-xs mt-1">
                  Kenya's tropical coastal escape
                </p>
            ...
            <div>
              ...
              <p className="mt-6 text-gray-600 leading-relaxed">
                Diani Beach is one of Kenya's most beautiful coastal
                destinations, famous for its soft white sands, turquoise
                Indian Ocean waters and relaxed tropical atmosphere.
              </p>

              <p className="mt-4 text-gray-600 leading-relaxed">
                From peaceful days beside the ocean to exciting marine
                adventures and authentic coastal experiences, Diani offers
                the perfect setting for relaxation and discovery.
              </p>
