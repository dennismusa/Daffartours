  ...
  const highlights = [
    {
      ...
      text: "Tarangire is famous for its impressive elephant herds, often seen moving between the baobab trees and seasonal water sources.",
    },
    {
      number: "02",
      title: "Ancient Baobabs",
      text: "Discover the park's iconic baobab trees, creating a dramatic and unmistakable African landscape.",
    },
    {
      number: "03",
      title: "Rich Wildlife",
      text: "Explore diverse habitats filled with lions, elephants, giraffes, zebras, wildebeest and many other species.",
    },
    {
      number: "04",
      title: "Quiet Wilderness",
      text: "Enjoy a more intimate safari experience away from the larger crowds while discovering Tanzania's remarkable wilderness.",
    },
  ];
      ...
      <section className="relative min-h-[70vh] max-h-[800px] overflow-hidden">
        ...
        <div className="absolute bottom-10 left-6 md:left-16 max-w-3xl text-white">
          ...
          <p className="mt-4 text-white/80 text-lg md:text-xl max-w-2xl leading-relaxed">
            Ancient baobabs, magnificent elephant herds, golden savannahs,
            and unforgettable wildlife experiences in northern Tanzania.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="mt-5 text-gray-600 leading-relaxed">
              Explore golden grasslands, seasonal rivers, ancient trees
              and wildlife-filled woodlands across the Tarangire landscape.
            </p>
          ...
          <div className="grid lg:grid-cols-[1.15fr_.85fr] gap-6">
            ...
            <div className="flex flex-col justify-center bg-[#0D4825] rounded-[2rem] p-8 sm:p-10 lg:p-12">
              ...
              <p className="mt-6 text-white/65 leading-relaxed">
                A safari in Tarangire is about discovering wildlife within
                a landscape unlike any other. Watch elephants beneath
                towering baobabs, follow animal tracks and enjoy the
                peaceful rhythm of the African wilderness.
              </p>
              ...
              <div className="mt-7 space-y-4">
                ...
                <div className="flex gap-3">
                  ...
                  <p className="text-white/70 text-sm">
                    Magnificent elephant encounters
                  </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            <div>
              ...
              <p className="mt-6 text-white/65 leading-relaxed max-w-xl">
                Tarangire combines spectacular wildlife, iconic baobab
                trees and beautiful landscapes into a distinctive safari
                experience in northern Tanzania.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              <p className="mt-6 text-gray-600 leading-relaxed">
                Tarangire supports an impressive variety of wildlife.
                Every game drive offers the possibility of discovering
                elephants, predators, giraffes, plains animals and more.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              <p className="mt-6 text-gray-600 leading-relaxed">
                ...
                northern Tanzania adventure, we can help create an
            ...
            <div className="relative group">
              ...
              <img
                src={tarangire1}
                alt="Tarangire safari landscape"
                className="w-full h-[400px] sm:h-[520px] object-cover rounded-[2rem] shadow-2xl transition-transform duration-700 group-hover:scale-[1.03]"
              />
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <div className="text-center mb-10">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-gray-600 leading-relaxed">
              ...
              moments waiting for you in Tarangire National Park.
            </p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-10">
            ...
            <div className="p-6 rounded-2xl bg-white/[0.05] border border-white/10 hover:border-[#F39A08]/40 transition-all duration-300">
              ...
              <p className="mt-2 text-white/55 text-sm leading-relaxed">
                ...
                enjoy long days exploring the park.
              </p>
      ...
      <section className="relative bg-[#0D4825] overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-5 sm:px-8 py-16 sm:py-20 lg:py-28 text-center">
          ...
          <p className="mt-5 max-w-2xl mx-auto text-white/65 leading-relaxed">
            Let Daffar Tours & Travel help you turn your Tarangire dream
