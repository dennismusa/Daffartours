          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              <p className="mt-6 text-gray-600 leading-relaxed">
                Zanzibar is a tropical island destination known for its
                spectacular beaches, warm Indian Ocean waters and fascinating
                blend of African, Arab, Indian and European influences.
              </p>

              <p className="mt-4 text-gray-600 leading-relaxed">
                From wandering through the historic streets of Stone Town
                to relaxing beside the ocean, Zanzibar offers a perfect
                combination of culture, adventure and tropical relaxation.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="mt-5 text-gray-600 leading-relaxed">
              Discover tropical beaches, historic streets, vibrant culture
              and beautiful ocean landscapes across the island.
            </p>
          ...
          <div className="grid lg:grid-cols-[1.15fr_.85fr] gap-6">
            ...
            <div className="flex flex-col justify-center bg-[#0D4825] rounded-[2rem] p-8 sm:p-10 lg:p-12">
              ...
              <p className="mt-6 text-white/65 leading-relaxed">
                Zanzibar offers more than a beach holiday. Explore historic
                neighborhoods, sail across the Indian Ocean, discover local
                traditions and slow down beneath tropical skies.
              </p>
              ...
              <div className="mt-7 space-y-4">
                ...
                <div className="flex gap-3">
                  ...
                  <p className="text-white/70 text-sm">
                    Unforgettable Indian Ocean sunsets
                  </p>
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            <div>
              ...
              <p className="mt-6 text-white/65 leading-relaxed max-w-xl">
                Zanzibar brings together tropical scenery, fascinating
                history, island culture and unforgettable ocean adventures
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              <p className="mt-6 text-gray-600 leading-relaxed">
                Whether you want to relax beside the ocean, discover
                local culture or explore beneath the water, Zanzibar
            ...
            <div className="relative group">
              ...
              <img
                src={zanzibar4}
                alt="Zanzibar cultural experience"
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              <p className="mt-6 text-gray-600 leading-relaxed">
                ...
                honeymoon or cultural adventure, we can help create
